...
/**
 * @ClassName TestThreadedBinaryTree
 * @Description: TODO
 * @Author hl
 * @Date 2019/12/2
 * @Version V1.0
...
public class TestThreadedBinaryTree {
    public static void main(String[] args) {
        ...
        System.out.println("===============");
        //中前线索化二叉树
        binTree.threadNodes(root);
     //    binTree.threadNodes1(root);
      //  System.out.println(binTree.searchThreadNodes(fiveNode).value);
        //binTree.threadIterate();
      binTree.ThreadNodesShow();
    }
}
